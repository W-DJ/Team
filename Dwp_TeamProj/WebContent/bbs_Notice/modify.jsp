					...
					<table id="modTbl">
						<tbody id="modTblBody">
							...
							<tr>
								<td class="req">제목</td>
								<td>
									<input type="text" name="asubject" value="<%=asubject %>"
										size="50" id="asubject">
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="acontent" id="txtArea"  cols="89" wrap="hard"><%=acontent %></textarea>
								</td>
							</tr>			
						</tbody>
						...
						<tfoot>	
							...
							<tr>
								<td colspan="2" id="btnAreaTd" class="update">
									<button type="button" id="modNotBtn">수정하기</button>
